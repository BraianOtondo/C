...
typedef tnodo *ListaNumero; //Puntero al tipo de dato tnodo para no utilizar punteros de punteros

void insertarEnLista (ListaNumero *cabeza, int e);
void imprimirLista (ListaNumero cabeza);
void borrarLista (ListaNumero *cabeza);

int main(){
    int e;
    ListaNumero cabeza; //Indica la cabeza de la lista enlazada, si la perdemos no podremos acceder a la lista
...
void insertarEnLista (ListaNumero *cabeza, int e){
    ListaNumero nuevo; //Creamos un nuevo nodo
...
void borrarLista(ListaNumero *cabeza){
    ListaNumero actual; //Puntero auxiliar para eliminar correctamente la lista
